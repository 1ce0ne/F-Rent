...
public class GreetingWindowActivityDouble extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nextButton.setOnClickListener(v -> {
            Intent intent = new Intent(GreetingWindowActivityDouble.this, HowAddCardWindowActivityDouble.class);
