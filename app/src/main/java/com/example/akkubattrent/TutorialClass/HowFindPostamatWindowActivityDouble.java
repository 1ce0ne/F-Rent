...
public class HowFindPostamatWindowActivityDouble extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(HowFindPostamatWindowActivityDouble.this, HowRentProductWindowActivity.class);
