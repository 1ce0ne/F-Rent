...
public class UserProfileSeller extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.profile_user_seller);
        ...
        findViewById(R.id.frameUserSettings).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(UserProfileSeller.this, UserProfileSettings.class);
        ...
        linearLayoutFaq.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(UserProfileSeller.this, "В разработке", Toast.LENGTH_SHORT).show();
            }
        });
